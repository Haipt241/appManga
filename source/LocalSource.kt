...
import com.bigberry.comicvn.util.ChapterRecognition
import com.bigberry.comicvn.util.DiskUtil
import com.bigberry.comicvn.util.RarContentProvider
import com.bigberry.comicvn.util.ZipContentProvider
...
class LocalSource(private val context: Context) : CatalogueSource {
    companion object {
        ...
        private fun getBaseDirectories(context: Context): List<File> {
            val c = context.getString(com.bigberry.comicvn.R.string.app_name) + File.separator + "local"
    ...
    override fun toString() = context.getString(com.bigberry.comicvn.R.string.local_source)
