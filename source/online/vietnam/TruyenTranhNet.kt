 ...
 */
class TruyenTranhNet : HttpSource() {
    override val id: Long = 13

    override val name = "TruyenTranh.Net"

//    override val baseUrl = "http://192.168.1.7:8100/api"
    override val baseUrl = "http://truyentranh.net"
    val baseUrlApi = "https://truyentranhviet.org:8888/api"
//    val baseUrlApi = "http://192.168.1.2:8100/api"
//    val baseUrlApi = "http://172.20.10.6:8100/api"
    ...
    override fun headersBuilder() = Headers.Builder().apply {
        add("User-Agent", "A-TTN " + Build.MODEL + "/" + Build.VERSION.CODENAME)
    }
    ...
    override fun popularMangaRequest(page: Int): Request {
        ...
        return POST(baseUrlApi + "/manga/get", body = body, headers = headersBuilder().build())
    }
...
//                manga.url = mangaJson.getString("url")
    ...
    override fun searchMangaRequest(page: Int, query: String, filters: FilterList): Request {
        ...
        val body = RequestBody.create(JSON, jsonObject.toString())
        return POST(baseUrlApi + "/manga/search", body = body, headers = headersBuilder().build())
    }
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        ...
        return POST(baseUrlApi + "/manga/latest", body = body, headers = headersBuilder().build())
    }
    ...
    override fun chapterListRequest(manga: SManga): Request {
        ...
        val body = RequestBody.create(JSON, jsonObject.toString())
        return POST(baseUrlApi + "/manga/chapter", body = body, headers = headersBuilder().build())
    }
...
//                chapter.url = chapterJson.getString("url")
    ...
    override fun pageListRequest(chapter: SChapter): Request {
        ...
        val body = RequestBody.create(JSON, jsonObject.toString())
        return POST(baseUrlApi + "/manga/page", body = body, headers = headersBuilder().build())
    }
