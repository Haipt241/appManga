 ...
 */
class TruyenTranhViet : HttpSource() {
    override val id: Long = 12

    override val name = "TruyenTranhViet"

    override val baseUrl = "http://truyentranhtuan.com"
    val baseUrlApi = "https://truyentranhviet.org:8888/api"
//    val baseUrlApi = "http://192.168.1.7:8100/api"
    ...
    override fun headersBuilder() = Headers.Builder().apply {
        add("User-Agent", "A-TTV " + Build.MODEL + "/" + Build.VERSION.CODENAME)
    }
