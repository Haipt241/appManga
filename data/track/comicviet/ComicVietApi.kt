...
import com.bigberry.comicvn.data.track.comicviet.ComicVietInterceptor
...
class ComicVietApi(private val client: OkHttpClient, interceptor: ComicVietInterceptor) {
    ...
    private val rest = Retrofit.Builder()
            ...
            .build()
            .create(ComicVietApi.Rest::class.java)
        ...
        return Observable.defer {
            ...
            val data = jsonObject(
                ...
                "attributes" to jsonObject(
                    "status" to track.toComicVietStatus(),
        ...
        return Observable.defer {
            ...
            val data = jsonObject(
                ...
                "attributes" to jsonObject(
                    "status" to track.toComicVietStatus(),
                    "progress" to track.last_chapter_read,
                    "ratingTwenty" to track.toComicVietScore()
                )
            )
            // @formatter:on
    ...
    fun search(query: String): Observable<List<Track>> {
        return rest.search(query)
                .map { json ->
                    ...
                    data.map { ComicVietManga(it.obj) }
        ...
        return rest.findLibManga(track.remote_id, userId)
                .map { json ->
                    ...
                    if (data.size() > 0) {
                        ...
                        ComicVietLibManga(data[0].obj, manga).toTrack()
                    } else {
                        null
                    }
                }
    ...
    fun login(username: String, password: String): Observable<OAuth> {
        return Retrofit.Builder()
                ...
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                .build()
                .create(ComicVietApi.LoginRest::class.java)
