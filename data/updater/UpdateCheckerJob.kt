...
import com.bigberry.comicvn.Constants.NOTIFICATION_UPDATER_ID
                ...
                .map { result ->
                    if (result is GithubUpdateResult.NewUpdate) {
                        ...
                        NotificationCompat.Builder(context).update {
                            ...
                            setContentText(context.getString(com.bigberry.comicvn.R.string.update_check_notification_update_available))
                            setSmallIcon(android.R.drawable.stat_sys_download_done)
                            // Download action
                            addAction(android.R.drawable.stat_sys_download_done,
                                    context.getString(com.bigberry.comicvn.R.string.action_download),
