...
import com.bigberry.comicvn.data.database.models.ChapterImpl
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_BOOKMARK
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_CHAPTER_ID_SERVER
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_CHAPTER_NUMBER
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_DATE_FETCH
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_DATE_UPLOAD
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_ID
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_LAST_PAGE_READ
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_MANGA_ID
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_NAME
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_READ
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_SOURCE_ORDER
import com.bigberry.comicvn.data.database.tables.ChapterTable.COL_URL
import com.bigberry.comicvn.data.database.tables.ChapterTable.TABLE
...
class ChapterPutResolver : DefaultPutResolver<Chapter>() {
    ...
    override fun mapToContentValues(obj: Chapter) = ContentValues(11).apply {
        ...
        put(COL_CHAPTER_ID_SERVER, obj.chapterId)
        put(COL_URL, obj.url)
...
class ChapterGetResolver : DefaultGetResolver<Chapter>() {
    ...
    override fun mapFromCursor(cursor: Cursor): Chapter = ChapterImpl().apply {
        ...
        chapterId = cursor.getLong(cursor.getColumnIndex(COL_CHAPTER_ID_SERVER))
