...
internal class DownloadNotifier(private val context: Context) {
    ...
    private val notification by lazy {
        NotificationCompat.Builder(context)
                .setLargeIcon(BitmapFactory.decodeResource(context.resources, com.bigberry.comicvn.R.drawable.logo))
    }
    ...
    private fun doOnProgressChange(download: Download?, queue: DownloadQueue) {
        ...
        with(notification) {
            ...
            if (multipleDownloadThreads) {
                ...
                setContentText(context.getString(com.bigberry.comicvn.R.string.chapter_downloading_progress)
    ...
    fun onDownloadPaused() {
        with(notification) {
            setContentTitle(context.getString(com.bigberry.comicvn.R.string.chapter_paused))
            setContentText(context.getString(com.bigberry.comicvn.R.string.download_notifier_download_paused))
            setSmallIcon(com.bigberry.comicvn.R.drawable.ic_av_pause_grey_24dp_img)
            setAutoCancel(false)
            ...
            setContentIntent(NotificationHandler.openDownloadManagerPendingActivity(context))
            // Resume action
            addAction(com.bigberry.comicvn.R.drawable.ic_av_play_arrow_grey_img,
                    context.getString(com.bigberry.comicvn.R.string.action_resume),
                    NotificationReceiver.resumeDownloadsPendingBroadcast(context))
            //Clear action
            addAction(com.bigberry.comicvn.R.drawable.ic_clear_grey_24dp_img,
                    context.getString(com.bigberry.comicvn.R.string.action_clear),
