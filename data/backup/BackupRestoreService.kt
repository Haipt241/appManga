...
import com.bigberry.comicvn.data.backup.models.Backup.MANGAS
import com.bigberry.comicvn.data.backup.models.Backup.TRACK
import com.bigberry.comicvn.data.backup.models.Backup.VERSION
...
import com.bigberry.comicvn.util.chop
import com.bigberry.comicvn.util.isServiceRunning
import com.bigberry.comicvn.util.sendLocalBroadcast
...
class BackupRestoreService : Service() {
        ...
        return Observable.from(mangasJson)
                .concatMap {
                    ...
                    if (observable != null) {
                        ...
                        errors.add(Date() to "${manga.title} - ${getString(com.bigberry.comicvn.R.string.source_not_found)}")
                        restoreProgress += 1
                        val content = getString(com.bigberry.comicvn.R.string.dialog_restoring_source_not_found, manga.title.chop(15))
    ...
    private fun writeErrorLog(): File {
        try {
            if (errors.isNotEmpty()) {
                val destFile = File(externalCacheDir, "comicvn_restore.log")
    ...
    private fun mangaFetchObservable(source: Source, manga: Manga, chapters: List<Chapter>,
        ...
        return backupManager.restoreMangaFetchObservable(source, manga)
                ...
                .filter { it.id != null }
                .flatMap { m ->
                    chapterFetchObservable(source, m, chapters)
    ...
    private fun showRestoreProgress(progress: Int, amount: Int, title: String, errors: Int,
                                    content: String = getString(com.bigberry.comicvn.R.string.dialog_restoring_backup, title.chop(15))) {
