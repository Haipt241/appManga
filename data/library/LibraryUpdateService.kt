package com.bigberry.comicvn.data.library
...
import com.bigberry.comicvn.data.library.LibraryUpdateService.Companion.start
...
class LibraryUpdateService(
    ...
    private val notificationBitmap by lazy {
        BitmapFactory.decodeResource(resources, com.bigberry.comicvn.R.drawable.logo)
    }
    ...
    private val progressNotification by lazy { NotificationCompat.Builder(this)
            .setSmallIcon(com.bigberry.comicvn.R.drawable.ic_refresh_white_24dp_img)
            .setLargeIcon(notificationBitmap)
            .setOngoing(true)
            .addAction(com.bigberry.comicvn.R.drawable.ic_clear_grey_24dp_img, getString(android.R.string.cancel), cancelIntent)
    }
    ...
    private fun showResultNotification(updates: List<Manga>) {
        ...
        notificationManager.notify(Constants.NOTIFICATION_LIBRARY_RESULT_ID, notification {
            setSmallIcon(com.bigberry.comicvn.R.drawable.ic_book_white_24dp)
            setLargeIcon(notificationBitmap)
            setContentTitle(getString(com.bigberry.comicvn.R.string.notification_new_chapters))
            if (newUpdates.size > 1) {
                setContentText(getString(com.bigberry.comicvn.R.string.notification_new_chapters_text, newUpdates.size))
