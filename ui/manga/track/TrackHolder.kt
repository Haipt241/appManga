...
class TrackHolder(view: View, adapter: TrackAdapter) : RecyclerView.ViewHolder(view) {
    ...
    fun bind(item: TrackItem) = with(itemView) {
        ...
        if (track != null) {
            track_title.setTextAppearance(context, com.bigberry.comicvn.R.style.TextAppearance_Regular_Body1_Secondary)
            ...
            track_title.setTextAppearance(context, com.bigberry.comicvn.R.style.TextAppearance_Medium_Button)
            track_title.setText(com.bigberry.comicvn.R.string.action_edit)
            track_chapters.text = ""
            track_score.text = ""
            track_status.text = ""
        }
