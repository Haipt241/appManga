...
import com.bigberry.comicvn.util.getCoordinates
...
class ChaptersController : NucleusController<ChaptersPresenter>(),
    ...
    fun initAds()
    {
        ...
        mInterstitialAd?.setAdUnitId("ca-app-pub-1861901249300481/4261222331")
...
//             adapter.toggleFastScroller()
    ...
    override fun onItemClick(position: Int): Boolean {
        ...
        if (actionMode != null && adapter.mode == FlexibleAdapter.MODE_MULTI) {
            ...
            val interval = preferences.getIntervalShowAds()
            if (interval >= 4) {
                preferences.setIntervalShowAds(0)
                showAds()
            }
            else {
                preferences.setIntervalShowAds(interval + 1)
            }
