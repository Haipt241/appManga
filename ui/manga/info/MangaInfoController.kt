...
import com.bigberry.comicvn.ui.library.ChangeMangaCategoriesDialog
...
import com.bigberry.comicvn.util.snack
...
class MangaInfoController : NucleusController<MangaInfoPresenter>(),
    ...
    override fun inflateView(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(com.bigberry.comicvn.R.layout.manga_info_controller, container, false)
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(com.bigberry.comicvn.R.menu.manga_info, menu)
    }

    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            com.bigberry.comicvn.R.id.action_open_in_browser -> openInBrowser()
            com.bigberry.comicvn.R.id.action_share -> shareManga()
            com.bigberry.comicvn.R.id.action_add_to_home_screen -> addToHomeScreen()
    ...
    private fun setMangaInfo(manga: Manga, source: Source?) {
        ...
        with(view) {
            ...
            manga_status.setText(when (manga.status) {
                SManga.ONGOING -> com.bigberry.comicvn.R.string.ongoing
                SManga.COMPLETED -> com.bigberry.comicvn.R.string.completed
                SManga.LICENSED -> com.bigberry.comicvn.R.string.licensed
                else -> com.bigberry.comicvn.R.string.unknown
            })
    ...
    fun toggleFavorite() {
        ...
        if (view != null && !isNowFavorite && presenter.hasDownloads()) {
            view.snack(view.context.getString(com.bigberry.comicvn.R.string.delete_downloads_for_manga)) {
                setAction(com.bigberry.comicvn.R.string.action_delete) {
    ...
    fun openInBrowser() {
        ...
        try {
            ...
            val intent = CustomTabsIntent.Builder()
                    .setToolbarColor(context.getResourceColor(com.bigberry.comicvn.R.attr.colorPrimary))
                    .build()
    ...
    private fun shareManga() {
        ...
        try {
            ...
            val intent = Intent(Intent.ACTION_SEND).apply {
                type = "text/plain"
                putExtra(Intent.EXTRA_TEXT, context.getString(com.bigberry.comicvn.R.string.share_text, title, url))
            }
            startActivity(Intent.createChooser(intent, context.getString(com.bigberry.comicvn.R.string.action_share)))
        } catch (e: Exception) {
            context.toast(e.message)
        }
    }
    ...
    private fun setFavoriteDrawable(isFavorite: Boolean) {
        ...
        view?.fab_favorite?.setImageResource(if (isFavorite)
            com.bigberry.comicvn.R.drawable.ic_bookmark_white_24dp
        else
            com.bigberry.comicvn.R.drawable.ic_bookmark_border_white_24dp)
    }
    ...
    fun addToHomeScreen() {
        ...
        val dialog = MaterialDialog.Builder(activity)
                .title(com.bigberry.comicvn.R.string.shortcut_title)
    ...
    fun reshapeIconBitmap(addIntent: Intent, request: BitmapTypeRequest<out Any>) {
        ...
        val modes = intArrayOf(com.bigberry.comicvn.R.string.circular_icon,
                com.bigberry.comicvn.R.string.rounded_icon,
                com.bigberry.comicvn.R.string.square_icon,
                com.bigberry.comicvn.R.string.star_icon)
        ...
        fun getIcon(i: Int): Bitmap? {
            return when (i) {
                ...
                3 -> request.transform(CenterCrop(activity),
                        MaskTransformation(activity, com.bigberry.comicvn.R.drawable.mask_star)).toIcon()
                else -> null
            }
        }

        val dialog = MaterialDialog.Builder(activity)
                .title(com.bigberry.comicvn.R.string.icon_shape)
                .negativeText(android.R.string.cancel)
                ...
                .itemsCallback { _, _, i, _ ->
                    Observable.fromCallable { getIcon(i) }
                            ...
                            .subscribe({ icon ->
                                ...
                                activity.toast(com.bigberry.comicvn.R.string.icon_creation_fail)
                            })
                }
                .show()
