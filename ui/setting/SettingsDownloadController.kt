...
import com.bigberry.comicvn.util.DiskUtil
import com.bigberry.comicvn.widget.CustomLayoutPickerActivity
...
class SettingsDownloadController : SettingsController() {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) = with(screen) {
        titleRes = com.bigberry.comicvn.R.string.pref_category_downloads

        preference {
            key = Keys.downloadsDirectory
            titleRes = com.bigberry.comicvn.R.string.pref_download_directory
            onClick {
        ...
        switchPreference {
            ...
            titleRes = com.bigberry.comicvn.R.string.pref_download_only_over_wifi
            defaultValue = true
        }
        intListPreference {
            key = Keys.downloadThreads
            titleRes = com.bigberry.comicvn.R.string.pref_download_slots
        ...
        preferenceCategory {
            titleRes = com.bigberry.comicvn.R.string.pref_remove_after_read

            switchPreference {
                key = Keys.removeAfterMarkedAsRead
                titleRes = com.bigberry.comicvn.R.string.pref_remove_after_marked_as_read
                defaultValue = false
            }
            intListPreference {
                key = Keys.removeAfterReadSlots
                titleRes = com.bigberry.comicvn.R.string.pref_remove_after_read
                entriesRes = arrayOf(com.bigberry.comicvn.R.string.disabled, com.bigberry.comicvn.R.string.last_read_chapter,
                        com.bigberry.comicvn.R.string.second_to_last, com.bigberry.comicvn.R.string.third_to_last, com.bigberry.comicvn.R.string.fourth_to_last,
                        com.bigberry.comicvn.R.string.fifth_to_last)
        ...
        preferenceCategory {
            titleRes = com.bigberry.comicvn.R.string.pref_download_new
            ...
            multiSelectListPreference {
                ...
                titleRes = com.bigberry.comicvn.R.string.pref_download_new_categories
                ...
                preferences.downloadNewCategories().asObservable()
                        .subscribeUntilDestroy {
                            ...
                            summary = if (selectedCategories.isEmpty())
                                resources?.getString(com.bigberry.comicvn.R.string.all)
                            else
    ...
    class DownloadDirectoriesDialog : DialogController() {
        ...
        override fun onCreateDialog(savedViewState: Bundle?): Dialog {
            ...
            val externalDirs = getExternalDirs() + File(activity.getString(com.bigberry.comicvn.R.string.custom_dir))
        ...
        private fun getExternalDirs(): List<File> {
            val defaultDir = Environment.getExternalStorageDirectory().absolutePath +
                    File.separator + resources?.getString(com.bigberry.comicvn.R.string.app_name) +
