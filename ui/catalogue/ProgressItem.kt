...
class ProgressItem : AbstractFlexibleItem<ProgressItem.Holder>() {
    ...
    override fun getLayoutRes(): Int {
        return com.bigberry.comicvn.R.layout.catalogue_progress_item
    }
    ...
    class Holder(view: View, adapter: FlexibleAdapter<*>) : FlexibleViewHolder(view, adapter) {
        ...
        val progressBar = view.findViewById(com.bigberry.comicvn.R.id.progress_bar) as ProgressBar
        val progressMessage = view.findViewById(com.bigberry.comicvn.R.id.progress_message) as TextView
    }
