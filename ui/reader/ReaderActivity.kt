...
import com.bigberry.comicvn.ui.base.activity.BaseRxActivity
import com.bigberry.comicvn.ui.reader.viewer.base.BaseReader
import com.bigberry.comicvn.ui.reader.viewer.pager.horizontal.LeftToRightReader
import com.bigberry.comicvn.ui.reader.viewer.pager.horizontal.RightToLeftReader
import com.bigberry.comicvn.ui.reader.viewer.pager.vertical.VerticalReader
import com.bigberry.comicvn.ui.reader.viewer.webtoon.WebtoonReader
import com.bigberry.comicvn.util.GLUtil
import com.bigberry.comicvn.util.SharedData
import com.bigberry.comicvn.util.plusAssign
import com.bigberry.comicvn.util.toast
import com.bigberry.comicvn.widget.SimpleAnimationListener
import com.bigberry.comicvn.widget.SimpleSeekBarListener
...
class ReaderActivity : BaseRxActivity<ReaderPresenter>() {
    ...
    fun initAdview()
    {
        MobileAds.initialize(this, "ca-app-pub-1861901249300481/7994596257");
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(com.bigberry.comicvn.R.menu.reader, menu)
        return true
    }
