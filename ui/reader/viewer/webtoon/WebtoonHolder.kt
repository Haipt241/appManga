package com.bigberry.comicvn.ui.reader.viewer.webtoon
...
class WebtoonHolder(private val view: View, private val adapter: WebtoonAdapter) :
    ...
    private fun observeProgress() {
        ...
        progressSubscription = Observable.interval(100, TimeUnit.MILLISECONDS)
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe { progress ->
                    view.progress_text.text = view.context.getString(com.bigberry.comicvn.R.string.download_progress, progress)
                }
    ...
    private fun onImageDecodeError() {
        ...
        val layout = (view as ViewGroup).inflate(com.bigberry.comicvn.R.layout.reader_page_decode_error)
