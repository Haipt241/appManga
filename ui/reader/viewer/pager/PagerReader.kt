...
import com.bigberry.comicvn.ui.reader.ReaderChapter
...
abstract class PagerReader : BaseReader() {
     ...
     */
    val whiteColor by lazy { ContextCompat.getColor(context, com.bigberry.comicvn.R.color.textColorSecondaryDark) }

    /**
     * Text color for white theme.
     */
    val blackColor by lazy { ContextCompat.getColor(context, com.bigberry.comicvn.R.color.textColorSecondaryLight) }
    ...
    protected fun initializePager(pager: Pager) {
        ...
        this.pager = pager.apply {
            ...
            setId(com.bigberry.comicvn.R.id.view_pager)
