...
import com.bigberry.comicvn.ui.reader.viewer.base.PageDecodeErrorLayout
...
: FrameLayout(context, attrs) {
    ...
    private fun observeProgress() {
        ...
        progressSubscription = Observable.interval(100, TimeUnit.MILLISECONDS)
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe { progress ->
                    progress_text.text = context.getString(com.bigberry.comicvn.R.string.download_progress, progress)
                }
    }
    ...
    private fun setLoading() {
        ...
        progress_text.setText(com.bigberry.comicvn.R.string.downloading)
    }
    ...
    private fun onImageDecodeError(reader: PagerReader) {
        ...
        val layout = inflate(com.bigberry.comicvn.R.layout.reader_page_decode_error)
