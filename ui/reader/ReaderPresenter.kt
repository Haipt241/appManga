...
import com.bigberry.comicvn.source.LocalSource
...
import com.bigberry.comicvn.util.RetryWithDelay
...
class ReaderPresenter(
    ...
    internal fun setImageAsCover(page: Page) {
        try {
            if (manga.source == LocalSource.ID) {
                ...
                context.toast(com.bigberry.comicvn.R.string.cover_updated)
                return
            }
            ...
            if (manga.favorite) {
                ...
                context.toast(com.bigberry.comicvn.R.string.notification_first_add_to_library)
            }
        } catch (error: Exception) {
            context.toast(com.bigberry.comicvn.R.string.notification_cover_update_failed)
            Timber.e(error)
        }
    }
    ...
    internal fun savePage(page: Page) {
        ...
        val pictureDirectory = Environment.getExternalStorageDirectory().absolutePath +
                ...
                File.separator + context.getString(com.bigberry.comicvn.R.string.app_name)
        ...
        Observable
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({
                    context.toast(com.bigberry.comicvn.R.string.picture_saved)
                }, { error ->
                    Timber.e(error)
