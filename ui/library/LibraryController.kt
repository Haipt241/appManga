...
import com.bigberry.comicvn.ui.category.CategoryController
...
import com.bigberry.comicvn.widget.DrawerSwipeCloseListener
...
class LibraryController(
    ...
    override fun getTitle(): String? {
        return resources?.getString(com.bigberry.comicvn.R.string.label_library)
    }
    ...
    override fun inflateView(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(com.bigberry.comicvn.R.layout.library_controller, container, false)
    }
    ...
    override fun createSecondaryDrawer(drawer: DrawerLayout): ViewGroup {
        val view = drawer.inflate(com.bigberry.comicvn.R.layout.library_drawer) as LibraryNavigationView
    ...
    fun onNextLibraryUpdate(categories: List<Category>, mangaMap: Map<Int, List<LibraryItem>>) {
        ...
        if (mangaMap.isNotEmpty()) {
            ...
            view.empty_view.show(com.bigberry.comicvn.R.drawable.ic_book_black_128dp, com.bigberry.comicvn.R.string.information_empty_library)
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(com.bigberry.comicvn.R.menu.library, menu)

        val searchItem = menu.findItem(com.bigberry.comicvn.R.id.action_search)
        ...
        menu.findItem(com.bigberry.comicvn.R.id.action_filter).icon.mutate()
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        val filterItem = menu.findItem(com.bigberry.comicvn.R.id.action_filter)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            com.bigberry.comicvn.R.id.action_filter -> {
                navView?.let { drawer?.openDrawer(Gravity.END) }
            }
            com.bigberry.comicvn.R.id.action_update_library -> {
                activity?.let { LibraryUpdateService.start(it) }
            }
            com.bigberry.comicvn.R.id.action_edit_categories -> {
    ...
    override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean {
        mode.menuInflater.inflate(com.bigberry.comicvn.R.menu.library_selection, menu)
        return true
    }
    ...
    override fun onPrepareActionMode(mode: ActionMode, menu: Menu): Boolean {
        ...
        if (count == 0) {
            ...
            mode.title = resources?.getString(com.bigberry.comicvn.R.string.label_selected, count)
            menu.findItem(com.bigberry.comicvn.R.id.action_edit_cover)?.isVisible = count == 1
        }
        return false
    }
    ...
    override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean {
        when (item.itemId) {
            com.bigberry.comicvn.R.id.action_edit_cover -> {
                changeSelectedCover()
                destroyActionModeIfNeeded()
            }
            com.bigberry.comicvn.R.id.action_move_to_category -> showChangeMangaCategoriesDialog()
            com.bigberry.comicvn.R.id.action_delete -> showDeleteMangaDialog()
            else -> return false
        }
        return true
    }
    ...
    private fun changeSelectedCover() {
        ...
        if (manga.favorite) {
            ...
            startActivityForResult(Intent.createChooser(intent,
                    resources?.getString(com.bigberry.comicvn.R.string.file_select_cover)), REQUEST_IMAGE_OPEN)
        } else {
            activity?.toast(com.bigberry.comicvn.R.string.notification_first_add_to_library)
        }
    }
            ...
            try {
                ...
                activity.contentResolver.openInputStream(data.data).use {
                    ...
                    if (presenter.editCoverWithStream(it, manga)) {
                        ...
                        activity.toast(com.bigberry.comicvn.R.string.notification_cover_update_failed)
                    }
                }
