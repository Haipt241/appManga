...
class LibraryCategoryView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    fun onCreate(controller: LibraryController) {
        ...
        recycler = if (preferences.libraryAsList().getOrDefault()) {
            (swipe_refresh.inflate(com.bigberry.comicvn.R.layout.library_list_recycler) as RecyclerView).apply {
                layoutManager = LinearLayoutManager(context)
            }
        } else {
            (swipe_refresh.inflate(com.bigberry.comicvn.R.layout.library_grid_recycler) as AutofitRecyclerView).apply {
        ...
        swipe_refresh.setOnRefreshListener {
            if (!LibraryUpdateService.isRunning(context)) {
                ...
                context.toast(com.bigberry.comicvn.R.string.updating_category)
            }
