...
import com.bigberry.comicvn.widget.UndoHelper
...
class CategoryController : NucleusController<CategoryPresenter>(),
    ...
    override fun getTitle(): String? {
        return resources?.getString(com.bigberry.comicvn.R.string.action_edit_categories)
    }
    ...
    override fun inflateView(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(com.bigberry.comicvn.R.layout.categories_controller, container, false)
    }
    ...
    override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean {
        // Inflate menu.
        mode.menuInflater.inflate(com.bigberry.comicvn.R.menu.category_selection, menu)
    ...
    override fun onPrepareActionMode(mode: ActionMode, menu: Menu): Boolean {
        ...
        val editItem = mode.menu.findItem(com.bigberry.comicvn.R.id.action_edit)
    ...
    override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            com.bigberry.comicvn.R.id.action_delete -> {
                undoHelper = UndoHelper(adapter, this).apply {
                    ...
                    remove(adapter.selectedPositions, view!!,
                            com.bigberry.comicvn.R.string.snack_categories_deleted, com.bigberry.comicvn.R.string.action_undo, 3000)
                }
            }
            com.bigberry.comicvn.R.id.action_edit -> {
    ...
    fun onCategoryExistsError() {
        activity?.toast(com.bigberry.comicvn.R.string.error_category_exists)
    }
