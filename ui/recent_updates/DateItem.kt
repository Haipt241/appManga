...
class DateItem(val date: Date) : AbstractHeaderItem<DateItem.Holder>() {
    ...
    override fun getLayoutRes(): Int {
        return com.bigberry.comicvn.R.layout.recent_chapters_section_item
    }
    ...
    class Holder(view: View, adapter: FlexibleAdapter<*>) : FlexibleViewHolder(view, adapter, true) {
        ...
        val section_text = view.findViewById(com.bigberry.comicvn.R.id.section_text) as TextView
