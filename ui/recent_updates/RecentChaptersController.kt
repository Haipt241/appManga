...
import com.bigberry.comicvn.ui.base.controller.popControllerWithTag
...
class RecentChaptersController : NucleusController<RecentChaptersPresenter>(),
    ...
    override fun getTitle(): String? {
        return resources?.getString(com.bigberry.comicvn.R.string.label_recent_updates)
    }
    ...
    override fun inflateView(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(com.bigberry.comicvn.R.layout.recent_chapters_controller, container, false)
    }
        ...
        with(view) {
            ...
            swipe_refresh.refreshes().subscribeUntilDestroy {
                if (!LibraryUpdateService.isRunning(context)) {
                    ...
                    context.toast(com.bigberry.comicvn.R.string.action_update_library)
                }
    ...
    override fun onUpdateEmptyView(size: Int) {
        ...
        if (size > 0) {
            ...
            emptyView.show(com.bigberry.comicvn.R.drawable.ic_update_black_128dp, com.bigberry.comicvn.R.string.information_no_recent)
        }
    }
    ...
    override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean {
        mode.menuInflater.inflate(com.bigberry.comicvn.R.menu.chapter_recent_selection, menu)
    ...
    override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean {
        when (item.itemId) {
            com.bigberry.comicvn.R.id.action_mark_as_read -> markAsRead(getSelectedChapters())
            com.bigberry.comicvn.R.id.action_mark_as_unread -> markAsUnread(getSelectedChapters())
            com.bigberry.comicvn.R.id.action_download -> downloadChapters(getSelectedChapters())
            com.bigberry.comicvn.R.id.action_delete -> ConfirmDeleteChaptersDialog(this, getSelectedChapters())
                    .showDialog(router)
            else -> return false
        }
        return true
